...
function computeMaxTranslate() {
  let x = image.value.naturalWidth - document.documentElement.clientWidth
  let y = image.value.naturalHeight - document.documentElement.clientHeight
